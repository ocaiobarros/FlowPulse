  ...
  return (
    <div className={`min-h-screen bg-background grid-pattern scanlines relative ${isKiosk ? "" : "p-4 md:p-6 lg:p-8"}`}>
      ...
      <MonitoringHeader
        ...
        subtitle={`${config?.hostName || "Host"} • ${virt?.type === "vmware" ? "VMware ESXi" : virt?.type === "proxmox" ? "Proxmox VE" : "Hypervisor"}`}
        icon={<MonitorCheck className="w-5 h-5" style={{ color: accentColor }} />}
        backPath="/app/monitoring/virtual-machines"
